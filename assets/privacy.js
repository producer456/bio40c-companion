...
<p><strong>The site's creator does not track what you do here.</strong> By default this site sends no activity reports, notes, grades or quiz answers to the creator. If you explicitly connect a private course service, your coursework and learning progress synchronize with that service. There is no dashboard or shared class database where the creator or classmates can view your work.</p>
<p>Classmates cannot see your saved work by opening this website on their own devices. Everyone has their own separate progress. The site does not upload your work until you choose Connect & sync in Settings. Connected devices synchronize through your private service; you can disconnect there. You can also export a backup yourself.</p>
<ul>
<li><strong>Use this same browser to pick up where you left off.</strong> Connect each device to the same private service to share progress, or transfer an exported backup.</li>
...
<p>GitHub Pages receives normal website requests and logs visitors’ IP addresses for security. That is separate from your study data, which stays local unless you enable private synchronization. This site adds no analytics, advertising, tracking cookies or remote fonts. External links have their own privacy practices.</p>
